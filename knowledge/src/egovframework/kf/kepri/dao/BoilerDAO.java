...
public class BoilerDAO {
	private static final Logger logger = LoggerFactory.getLogger(BoilerDAO.class);
	...
	public RestResultVO getDetailData(ParameterVO paramVO)  throws Exception {
		...
		sbLog.append(  dcUtil.getLogInfo("ranking",
				"보일러" ,
				commonUtil.null2Str( paramVO.getUserId(),""), paramVO.getRepoName() + "#@@#" + paramVO.getKwd() + "#@@#" + "BOILER",
				paramVO.getPageNum(),
				false,
				paramVO.getSort(),
				commonUtil.null2Str( paramVO.getRecKwd(),"" )) );
