...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        onRefreshing: $.noop,
        onRefreshed: $.noop,
        onPageChanging: $.noop, //edit KONAN
        onPageChanged: $.noop,
        onItemDeleting: $.noop,
        onItemDeleted: $.noop,
        ...
        _createPagerButton: function(text, css, handler) {
            ...
            return $("<span>").addClass(css).append($link).on("click", $.proxy(handler, this));
        },
        ...
        openPage: function(pageIndex) {
            ...
            //edit KONAN
            var args = this._callEventHandler(this.onPageChanging, {
                pageIndex: pageIndex
            });
            if(args.cancel)
            	return;
        ...
        insertItem: function(item, itemIndex) {
            ...
            return this._controllerCall("insertItem", insertingItem, args.cancel, function(insertedItem) {
                ...
                this._loadStrategy.finishInsert(insertedItem, itemIndex);
        ...
        _editRow: function($row) {
            ...
            this._callEventHandler(this.onItemEdited, {
            	editrow: $editRow,
                row: $row,
                item: item,
                itemIndex: this._itemIndex(item)
...
(function(jsGrid, $, undefined) {
    ...
    DirectLoadingStrategy.prototype = {
        ...
        //edit KONAN
        finishInsert: function(insertedItem, insertItemIndex) {
            var grid = this._grid;
            grid.option("data").splice(insertItemIndex, 0, insertedItem);
    ...
    PageLoadingStrategy.prototype = {
        ...
        //edit KONAN
        finishInsert: function(insertedItem, insertedItemIndex) {
        	var grid = this._grid;
            grid.option("data").splice(insertedItemIndex, 0, insertedItem);
            grid.refresh();
            //this._grid.search();
        },
