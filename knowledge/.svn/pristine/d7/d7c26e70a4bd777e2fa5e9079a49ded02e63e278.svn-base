...
import egovframework.kf.kepri.dao.GenPrevDAO;
import egovframework.kf.kepri.service.GenPrevService;
import egovframework.rte.fdl.cmmn.EgovAbstractServiceImpl;
import egovframework.rte.fdl.property.EgovPropertyService;

@Service("genPrevService")
public class GenPrevServiceImpl extends EgovAbstractServiceImpl implements GenPrevService {
	
	/** genPrevDAO */
	@Resource(name = "genPrevDAO")
	private GenPrevDAO genPrevDAO;
	...
	public RestResultVO genSearch(ParameterVO paramVO) throws Exception {
		RestResultVO resultVO = genPrevDAO.search(paramVO);
		if (resultVO == null)
			throw processException("info.nodata.msg");
		
		resultVO = genPrevDAO.getExtractImgList(paramVO.getCategory(), resultVO);
	...
	public Map<String, Object> getDetailData(ParameterVO paramVO) throws Exception {
		...
		String message = "";
		RestResultVO resultVO = genPrevDAO.getDetailData(paramVO);
		if (resultVO == null)
			throw processException("info.nodata.msg");
		else {
			...
			RestResultVO resultPartVO = genPrevDAO.getDetailPartData(paramVO);
	...
	public RestResultVO getSymptom(String category, String idx) throws Exception {
		...
		RestResultVO metaVO = genPrevDAO.getMeta(category, idx);
		if ( metaVO == null )
			throw processException("info.nodata.msg");
		...
		RestResultVO resultVO = genPrevDAO.getSymptom(category, powerCompNm, powerStNm, stNO);
